...
from .ml_strategies import Fonceur1v1MLStrategy
...
def get_team(nb_players):
    ...
    if nb_players == 1:
        ...
        # myteam.add("  9_Guerrero", Fonceur1v1MLStrategy(fn_fon="ml_fon_0512_2.pkl", fn_gk="1v1_gk_dico_0505_1.pkl", fn_st="1v1_st_dico_0505_1.pkl"))
    if nb_players == 2:
