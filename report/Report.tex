...
match, et est r\'ep\'et\'ee autant de fois qu'il y a d'\'episodes. On commence 
par choisir un \'etat initial $s_0$, sauf qu'il est toujours le m\^eme pour un 
match de football : ceci correspond au coup d'envoi. Puis on choisit une action 
$a_t$ selon la politique $Q$ et observe la r\'ecompense associ\'ee \`a cette 
paire. Cette action g\'en\`ere un nouvel \'etat $s_{t+1}$.
\todo{Formule de Q}
