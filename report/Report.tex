...
\begin{center}
\includegraphics[width=0.8\textwidth]{../img/apercu.png}\par%\vspace{1cm}
\end{center}
...
\section*{Strat\'egies}
\begin{center}  
  \includegraphics[width=1.\textwidth]{../img/baseStrategies.png}\par
\end{center}

\begin{center}
  \includegraphics[width=0.9\textwidth]{../img/gridSearch.png}\par
\end{center}

\begin{center}
\includegraphics[width=1.\textwidth]{../img/decisionTree.png}\par
\end{center}

\section*{Classes suppl\'ementaires}
\begin{center}
  \includegraphics[width=0.3\textwidth]{../img/genetic_mod.png}\par
\end{center}

\begin{center}
\includegraphics[width=0.8\textwidth]{../img/machineLearning_mod.png}\par
\end{center}
...
\begin{center}
  \includegraphics[width=0.8\textwidth]{../img/packages_IA.png}\par%\vspace{1cm}
\end{center}
