...
\begin{figure}[!h]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[width=0.5\textwidth]{1joueur}
  \caption[Un exemple de l'\'equipe \`a un joueur]{Voici un exemple de la 
	pression de pr\`es du joueur adverse sur notre {\itshape fonceur}}
  \label{fig:1j}
\end{figure}
...
comme vous pouvez l'apercevoir dans la figure \ref{fig:2j}.

\begin{figure}[!h]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[width=0.5\textwidth]{2joueur}
  \caption[Un exemple de l'\'equipe \`a deux joueurs]{Voici un exemple 
	tr\`es explicite de notre devise avec notre {\itshape gardien} Beckenbauer 
	et notre {\itshape attaquant} Messi}
  \label{fig:2j}
\end{figure}
...
\begin{figure}[!h]
  \centering
  \captionsetup{justification=centering}
  \includegraphics[width=0.9\textwidth]{4joueur}
  \caption[Un exemple de l'\'equipe \`a quatre joueurs]{Voici un 
exemple de notre devise maintenue dans la cat\'egorie \`a quatre joueurs avec 
notre {\itshape d\'efenseur} Beckenbauer, notre {\itshape gardien} Matthaus et 
nos deux {\itshape attaquants} Pele et Guerrero}
  \label{fig:4j}
\end{figure}
