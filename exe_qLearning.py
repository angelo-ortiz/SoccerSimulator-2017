...
MLTeam = LearningTeam(numPlayers=2, playerStrats=stratsList, oppList=opponentsList, numIter=30, numMatches=2, graphical=False) #t = 1120
# MLTeam = LearningTeam(numPlayers=2, playerStrats=stratsList, oppList=opponentsList[:1], numIter=1, numMatches=1, graphical=True)
# MLTeam.initialize()
MLTeam.initialize(["ml_st_0510_2.pkl", "ml_gk_0510_2.pkl", None, None])
MLTeam.start()
while MLTeam.next_match():
    MLTeam.start()
MLTeam.printQTableDebug(0)
MLTeam.save(["ml_st_0510_2.pkl", "ml_gk_0510_2.pkl", None, None])
