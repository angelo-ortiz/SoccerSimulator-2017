...
MLTeam = LearningTeam(numPlayers=2, playerStrats=stratsList, oppList=opponentsList, numIter=1, numMatches=1, graphical=False)
MLTeam.initialize()
#MLTeam.initialize(["ml_st_0507_1.pkl", "ml_gk_0507_1.pkl", None, None])
MLTeam.start()
while MLTeam.next_match():
    MLTeam.start()
#MLTeam.printQTableDebug(0)
MLTeam.save(["ml_st_0507_2.pkl", "ml_gk_0507_2.pkl", None, None])
